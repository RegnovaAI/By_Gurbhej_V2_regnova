...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`w-full md:w-64 bg-[#3e5074] md:bg-transparent text-white fixed inset-y-0 left-0 z-20 transform transition-transform duration-300 ease-in-out sidebar-scrollbar overflow-y-auto
          ${
      ...
      >
        <div className="p-5">
          <div className="flex items-center mb-8 justify-between">
            ...
            <button
              className="self-end text-white focus:outline-none md:hidden"
