...
export default function Mission() {
  return (
    <div
      className="min-h-screen items-center justify-center flex flex-col text-white px-4 py-10"
      style={{
